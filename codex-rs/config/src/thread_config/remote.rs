...
fn model_provider_from_proto(
    ...
    let info = ModelProviderInfo {
        ...
        stream_setup_timeout_ms: provider.stream_setup_timeout_ms,
        sampling_timeout_ms: provider.sampling_timeout_ms,
                ...
                source: Some(proto::thread_config_source::Source::Session(
                    proto::SessionThreadConfig {
                        ...
                        model_providers: vec![proto::ModelProvider {
                            ...
                            stream_setup_timeout_ms: Some(11_000),
                            sampling_timeout_ms: Some(12_000),
